...
namespace MyPics.Infrastructure.Migrations
{
    ...
    [Migration("20210219152435_RefactorPrivateMessaging")]
    partial class RefactorPrivateMessaging
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPics.Domain.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("UserConversationConversationId")
                        .HasColumnType("int");

                    b.Property<int?>("UserConversationUserId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserConversationUserId", "UserConversationConversationId");
            ...
            modelBuilder.Entity("MyPics.Domain.Models.UserConversation", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyPics.Domain.Models.Conversation", b =>
                {
                    b.HasOne("MyPics.Domain.Models.UserConversation", null)
                        .WithMany("Conversations")
                        .HasForeignKey("UserConversationUserId", "UserConversationConversationId");
                });
            ...
            modelBuilder.Entity("MyPics.Domain.Models.Message", b =>
                {
                    b.HasOne("MyPics.Domain.Models.Conversation", "Conversation")
                        .WithMany("Messages")
